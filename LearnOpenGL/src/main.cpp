...
int main(void)
{
    ...
    window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Hello Dude From OpenGL", NULL, NULL);
    if (!window)
    {
        glfwTerminate();
        return -1;
   ...
   // Shader ourShader("3.3.shader.vs", "3.3.shader.fs"); // you can name your shader files however you like
    ...
    Model bugatti(("resources/models/hammer/valhalla_hammer.obj"));
